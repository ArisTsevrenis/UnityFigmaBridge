...
namespace UnityFigmaBridge.Editor.Nodes
{
    ...
    public static class FigmaAssetGenerator
    {
        ...
        /// <summary>Is invoked when a gameobject (and its children) that represents a page has been created but not yet become a prefab </summary>
        public static event Action<GameObject> OnScreenPrefabToBeCreated;
        ...
        private static void SaveFigmaScreenAsPrefab(Node node, Node parentNode, RectTransform screenRectTransform, FigmaImportProcessData figmaImportProcessData)
        {
            ...
            OnScreenPrefabToBeCreated?.Invoke(screenRectTransform.gameObject);
            // Write prefab
